    ...
    return (
        ...
        <div className="footer" id="contact-me">
            ...
            <div className="about-me">
                ...
                <p>
                    I LIVE Programming. I BREATHE Programming. <i className="em em-heartbeat" aria-label="BEATING HEART"></i><br />
                    A Web-Developer by Day & A Curious Programmer by Night <i className="em em-last_quarter_moon" aria-label="LAST QUARTER MOON SYMBOL"></i><br />
                    Oh, and I Have Some Unexplained Attraction to CSS <i className="em em-sweat_smile" aria-label="SMILING FACE WITH OPEN MOUTH AND COLD SWEAT"></i><br />
            ...
            <div className="footer-links">
                ...
                <a target="_blank" rel="noopener noreferrer" href="http://codepen.io/EvyatarDa/">
                    <i className="lab la-codepen"></i>
                     {/* Codepen */}
                    {/* <!-- StyleShit --> */}
                </a>
                
                <a target="_blank" rel="noopener noreferrer" href="https://github.com/StyleShit">
